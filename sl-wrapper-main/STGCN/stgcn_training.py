####
# Let's solve the problem of class imbalance!
#
####
import os
import argparse
...
test_loader = torch.utils.data.DataLoader(test_ds, batch_size=32, shuffle=False, num_workers=2, pin_memory=True,
...
epoch = 0
best_val_score = 0
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, milestones=[100,150], gamma=0.1)
