...
# trained weights
#weights_path = '/Users/zzenninkim/Documents/Research/sl-wrapper-main/recognition_mod/STGCN/ALL_weights/_training_from_asllrp044016_0.791928.pt'
#weights_path = '/Users/zzenninkim/Documents/Research/sl-wrapper-main/recognition_mod/STGCN/ALL_weights/ASLLRP_retrain/_training_from_asllrp002620_0.511590.pt'

#weights_path = "/Users/zzenninkim/Documents/Research/sl-wrapper-main/recognition_mod/STGCN/ALL_weights/saved_weights_Train_250331_ASLLVD+ASLLRP_996_gloss/_training_from_aslcitizen_0331004340_0.550341.pt"
weights_path = "/Users/zzenninkim/dataset/ASLLRP/saved_weights/_training_from_aslcitizen_weight007440_0.525458.pt"
...
def recognize_segments_in_video(pose_npy_path, segment, fps):
    ...
    # asllrp
    df = pd.read_csv('/Users/zzenninkim/dataset/ASLLRP/ASLLRP_gloss_top15.csv')
    ...
    for start_t, end_t in segment:
        ...
        # (T, C, V) → (T', C, V)
        segmented_pose_data = pose_data[start_frame:end_frame+1, :, :]  # 선택된 프레임만 사용
        length = segmented_pose_data.shape[0]

        if length > 128:
            segmented_pose_data = downsample(segmented_pose_data, 128)  # 128 초과 시 줄이기
        if length < 128:
            segmented_pose_data = np.pad(segmented_pose_data, ((0, 128 - length), (0, 0), (0, 0)))  # 부족한 부분 채우기
        ...
        posedata = segmented_pose_data[:, 0:33, :]  # body (33개)
        ...
        #result_list.append((start_t, end_t, mapped_labels))
...
if __name__ == "__main__":
    ...
    video_path = "/Users/zzenninkim/Documents/Research/asl-search-automation-main/src/tmp/video-1747694921528-796772039.mp4"
    segment_txt = "/Users/zzenninkim/Documents/Research/asl-search-automation-main/src/tmp/video-1747694921528-796772039.txt"
    ...
    # JSON results
    output_json_path = os.path.join(segment_txt.split(".")[0]+"_"+ weights_name+".json")
