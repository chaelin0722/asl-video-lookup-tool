...
# Update paths here
src_path = '/Users/zzenninkim/dataset/ASLLRP/batch_signs_v1_1/'
dst_path = '/Users/zzenninkim/dataset/ASLLRP/batch_signs_v1_1_pose_files/'
data_csv = '/Users/zzenninkim/dataset/ASLLRP/cleaned_gloss_labels.csv'
...
with open(data_csv, 'r') as file:
    ...
    for row in reader:
        ...
        check_f = dst_path + row[0].split(".")[0] + '.npy'
