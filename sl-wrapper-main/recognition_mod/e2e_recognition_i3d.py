...
model.load_state_dict(torch.load('/Users/zzenninkim/Documents/Research/sl-wrapper-main/recognition_mod/ASL_citizen_I3D_weights.pt',map_location=torch.device('cpu')))
...
if __name__ == "__main__":
    ...
    # get information from each segments
