...
dst_path = "/Users/zzenninkim/dataset/ASLLVD/80_npys/"
data_csv = "/Users/zzenninkim/dataset/ASLLVD/10_gloss_videoname_startend_frame.csv"
...
with open(data_csv, 'r') as file:
    ...
    for row in reader:
        ...
        check_f = dst_path + row[1].split(".")[0] + '.npy'
        ...
        with mp_holistic.Holistic(
            ...
            name = ''.join(row[1].split(".")[0])
            np.save(dst_path + name + "_"+ str(start_frame) +"_"+ str(end_frame) +'.npy', feature)
