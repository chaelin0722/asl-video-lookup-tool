...
train_file = "/Users/zzenninkim/dataset/ASL_Citizen/splits/train.csv"
test_file = "/Users/zzenninkim/dataset/ASL_Citizen/splits/test.csv"
...
test_loader = torch.utils.data.DataLoader(test_ds, batch_size=8, shuffle=True, num_workers=0, pin_memory=True)
...
i3d.load_state_dict(torch.load('/Users/zzenninkim/Documents/Research/CHI-2025-SLD/chi2025-sign-language-dictionary-main/gradio-recognition-screen/ASL_citizen_I3D_weights.pt', map_location=torch.device('cpu')))
i3d.cpu()
